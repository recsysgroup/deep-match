...
def table_dataset_and_decode_builder_v2(table, config, extra_fields=[],
                                        fea_sides=['user', 'item'],
...
def train_input_fn_builder(config):
    def input_fn():
        ...
        if FLAGS.train_pair_table:
            pair_dataset, pair_decode = table_dataset_and_decode_builder(FLAGS.train_pair_table, config,
